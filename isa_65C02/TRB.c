...
ISA_65C02_DISASM(TRB)
{
    ...
    switch ( opcode_context->addressing_mode ) {
        ...
        case isa_6502_addressing_zeropage:
            ...
            return snprintf(buffer, buffer_len, "TRB $%02hhX {~$%02hhX AND $%02hhX => $%02hhX ------%hhu-}",
        ...
        case isa_6502_addressing_absolute:
            ...
            return snprintf(buffer, buffer_len, "TRB $%02hhX%02hhX {~$%02hhX AND $%02hhX => $%02hhX ------%hhu-}",
